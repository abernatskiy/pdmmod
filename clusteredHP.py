#! /usr/bin/python2
from analysisHP import *

class ClusteredResults(Results):
    def __init__(self,simIndx,minLength=6,howMany=0.01,samp=None,epsilonModifyer={0:0},cluster=True):
        Results.__init__(self,simIndx,howMany=0.01)
        if cluster:
