...
def analyzeRuntime(command,runs,minpop,multiplier,numPoints,plot=True):
    ...
    print('optimization: ',optimization.curve_fit(func, [r[0] for r in runtimes], [r[1] for r in runtimes],[0.0,0.0],[r[2] for r in runtimes]))
    ...
    ax0.plot(element[0],func(element[0],0.00057,0.0),'--')
